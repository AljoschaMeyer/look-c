...
typedef enum {
  ...
  LANGLE, RANGLE, COMMA, DOLLAR, PLUS, PLUS_WRAPPING, MINUS, MINUS_WRAPPING,
  TIMES, TIMES_WRAPPING, DIV, MOD, COLON, SEMI, PIPE, SCOPE, ARROW, FAT_ARROW,
  BEGIN_ATTRIBUTE, UNDERSCORE, ID, INT, FLOAT, STRING, USE, KW_MOD, DEP, MAGIC,
  GOTO, LABEL, BREAK, RETURN, IF, ELSE, WHILE, CASE, LOOP, AS, VAL, FN, TYPE,
  MACRO, MUT, PUB, FFI, SIZEOF, ALIGNOF, HALT, KW_TRUE, KW_FALSE, PLUS_ASSIGN,
  PLUS_WRAPPING_ASSIGN, MINUS_ASSIGN, MINUS_WRAPPING_ASSIGN, TIMES_ASSIGN,
  TIMES_WRAPPING_ASSIGN, DIV_ASSIGN, MOD_ASSIGN, XOR_ASSIGN, AND_ASSIGN,
  OR_ASSIGN, XOR, AMPERSAND, LOR, LAND, NOT, EQUALS, NOTEQUALS, GREATER,
  GREATER_EQ, SMALLER, SMALLER_EQ, END,
