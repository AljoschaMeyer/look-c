...
typedef enum {
  ...
  MACRO, MUT, PUB, FFI, SIZEOF, ALIGNOF, PLUS_ASSIGN, PLUS_WRAPPING_ASSIGN,
  MINUS_ASSIGN, MINUS_WRAPPING_ASSIGN, TIMES_ASSIGN, TIMES_WRAPPING_ASSIGN,
  DIV_ASSIGN, MOD_ASSIGN, XOR_ASSIGN, AND_ASSIGN, OR_ASSIGN, XOR, AMPERSAND,
  LOR, LAND, NOT, EQUALS, NOTEQUALS, GREATER, GREATER_EQ, SMALLER, SMALLER_EQ,
  END,
