...
//
//   if (cx->mods_mod == NULL) {
//     cx->mods_mod = malloc(sizeof(AsgMod));
//     cx->mods_mod->bindings_by_sid = raxNew();
//     cx->mods_mod->pub_bindings_by_sid = NULL; // not used
//
//     // for each file in the mods dir, parse the file and add it to mods_mod
//     // for each dir in the mods dir, recurse, adding to a binding of mods_mod
//     //
//     // then, oo_init_mods for all files encountered this way
//
//     // abort();
//     // TODO init mods_mod
//   }
