...
void test_pattern(void) {
  ...
  assert(data.ptr->id.sid.src == src + 3);
...
void test_exp(void) {
  ...
  assert(data.product_repeated.inner->src == src + 2);
  ...
  assert(data.product_anon[0].src == src + 2);
  assert(data.product_anon[0].len == 1);
  free_inner_exp(data);
  ...
  assert(data.product_anon[1].src == src + 5);
  assert(data.product_anon[1].len == 2);
  free_inner_exp(data);
  ...
  assert(data.product_named.inners[0].src == src + 6);
  assert(data.product_named.inners[0].len == 1);
  assert(sb_count(data.product_named.sids) == 1);
  assert(data.product_named.sids[0].src == src + 2);
  assert(data.product_named.sids[0].len == 1);
  free_inner_exp(data);
  ...
  assert(data.product_named.inners[1].src == src + 13);
  assert(data.product_named.inners[1].len == 2);
  assert(sb_count(data.product_named.sids) == 2);
  assert(data.product_named.sids[0].src == src + 2);
  assert(data.product_named.sids[0].len == 1);
  assert(data.product_named.sids[1].src == src + 9);
  assert(data.product_named.sids[1].len == 1);
  free_inner_exp(data);
  ...
  assert(data.len == strlen(src) - 1);
  assert(data.src == src + 1);
  assert(data.size_of->src == src + 10);
  ...
  assert(data.len == strlen(src) - 1);
  assert(data.src == src + 1);
  assert(data.align_of->src == src + 11);
  ...
  assert(data.len == strlen(src) - 1);
  assert(data.src == src + 1);
  assert(data.exp_negate->src == src + 2);
  ...
  assert(data.len == strlen(src) - 1);
  assert(data.src == src + 1);
  assert(data.val.src == src + 5);
  assert(data.val.len == 1);
  ...
  assert(data.len == strlen(src) - 1);
  assert(data.src == src + 1);
  assert(data.val_assign.lhs.src == src + 5);
  assert(data.val_assign.lhs.len == 1);
  assert(data.val_assign.lhs.tag == PATTERN_ID);
  assert(data.val_assign.rhs->src == src + 9);
  assert(data.val_assign.rhs->len == 2);
  ...
  assert(data.len == strlen(src) - 1);
  assert(data.src == src + 1);
  assert(data.exp_return->src == src + 8);
  assert(data.exp_return->len == 2);
  ...
  assert(data.len == strlen(src) - 1);
  assert(data.src == src + 1);
  assert(data.exp_break->src == src + 7);
  assert(data.exp_break->len == 2);
  ...
  assert(data.len == strlen(src) - 1);
  assert(data.src == src + 1);
  assert(data.exp_goto.src == src + 6);
  ...
  assert(data.len == strlen(src) - 1);
  assert(data.src == src + 1);
  assert(data.exp_label.src == src + 7);
  ...
  assert(data.len == strlen(src) - 1);
  assert(data.src == src + 1);
  assert(data.deref_mut->src == src + 1);
  ...
  assert(data.product_access_named.field.src == src + 3);
  free_inner_exp(data);
